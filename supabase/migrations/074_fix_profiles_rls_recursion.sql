-- Migration 074: Fix profiles RLS recursion using a SECURITY DEFINER helper function
-- =================================================================================

-- 1. Create helper function to bypass RLS recursion during profile select validation
